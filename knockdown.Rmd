...
for (gene in unique(dat_gene$Gene)) 
{
  ...
  N <- nrow(table)
  Padjust <- formattable(as.double(geneExp$padj[1]), digits = 2, format = "f")
# Plot
...
for (gene in unique(datVDV2$Experiment)) 
{
  ...
  N <- nrow(table)
  Padjust <- formattable(as.double(VDV2Load$padj[1]), digits = 2, format = "f")
# Plot
   p <- ggboxplot(table, x = "Treatment", y = "RQ", 
          main = paste(gene, ", Padjust=",Padjust ,", n=", N),
          color = "Treatment", palette = c("#00AFBB", "#E7B800"),
...
for (gene in unique(datARV2$Experiment)) 
{
  ...
  N <- nrow(table)
  Padjust <- formattable(as.double(ARV2Load$padj[1]), digits = 2, format = "f")
# Plot
   p <- ggboxplot(table, x = "Treatment", y = "RQ", 
          main = paste(gene, ", Padjust=",Padjust ,", n=", N),
          color = "Treatment", palette = c("#00AFBB", "#E7B800"),
...
for (gene in unique(datDWVa$Experiment)) 
{
  ...
  N <- nrow(table)
  Padjust <- formattable(as.double(DWVaLoad$padj[1]), digits = 2, format = "f")
# Plot
   p <- ggboxplot(table, x = "Treatment", y = "RQ", 
          main = paste(gene, ", Padjust=",Padjust ,", n=", N),
          color = "Treatment", palette = c("#00AFBB", "#E7B800"),
